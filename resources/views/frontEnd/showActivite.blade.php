...
<section class="sec1">
  <div class="grid-2 sec1_row1">
    <div class="about wow right-animation">
      <h2>{{$Activite->name}}</h2>
      <h5>animé par {{$Activite->name}} à {{$Activite->date_debut}} </h5>
      <p class="about_p" >
        {{$Activite->detail}}
      </p>
...
<section class="container pic wow fadeup-animation">
  ...
  <div>
    <iframe width="560" height="315" src={{ $Activite->video->first()->URL . "&output=embed" }} frameborder="0" allowfullscreen>
    </iframe>
  </div>
